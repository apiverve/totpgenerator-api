// Package totpgenerator provides a Go client for the TOTP Generator API.
//
// For more information, visit: https://apiverve.com/marketplace/totpgenerator?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the TOTP Generator API.
//
// Parameters:
//   - secret (required): string - Base32-encoded shared secret
//   - digits: integer - Number of digits in token [min: 6, max: 8]
//   - period: integer - Time period in seconds [min: 1, max: 300]
type Request struct {
	Secret string `json:"secret"` // Required
	Digits int `json:"digits,omitempty"` // Optional
	Period int `json:"period,omitempty"` // Optional
}
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		...
		"digits": {Type: "integer", Required: false, Min: float64Ptr(6), Max: float64Ptr(8)},
		"period": {Type: "integer", Required: false, Min: float64Ptr(1), Max: float64Ptr(300)},
	}
...
// ResponseData contains the data returned by the TOTP Generator API.
