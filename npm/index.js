...
class totpgeneratorWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/totpgenerator');
        }
        ...
        this.validationRules = {"secret":{"type":"string","required":true},"digits":{"type":"integer","required":false,"min":6,"max":8,"default":6},"period":{"type":"integer","required":false,"min":1,"max":300,"default":30}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/totpgenerator`);
        }
    }
...
module.exports = totpgeneratorWrapper;
