...
```gradle
dependencies {
    implementation 'com.github.apiverve:totpgenerator-api:1.1.12'
}
```
...
```java
import com.apiverve.totpgenerator.TOTPGeneratorAPIClient;
import com.apiverve.totpgenerator.APIResponse;
import com.apiverve.totpgenerator.APIException;

// Initialize the client
TOTPGeneratorAPIClient client = new TOTPGeneratorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/totpgenerator](https://docs.apiverve.com/ref/totpgenerator)
...
- **Documentation:** [https://docs.apiverve.com/ref/totpgenerator](https://docs.apiverve.com/ref/totpgenerator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/totpgenerator-api/issues)
